...
/* Subroutine */ int check0_(real *sfac)
{
    ...
    static real sa, sb, sc, ss, dtemp[9];
...
/* Subroutine */ int check2_(real *sfac)
{
    ...
    /* Local variables */
    static integer i__, j, ki, kn, mx, my;
    static real sx[7], sy[7];
    static integer kni;
    static real stx[7], sty[7];
...
/*     .. Executable Statements .. */
	...
	if ((r__2 = *sfac * sd, dabs(r__2)) <= (r__1 = ssize[i__], dabs(r__1))
		 * epsilon_(&c_b63)) {
	    goto L40;
	}
