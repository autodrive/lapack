/* sblat3.f -- translated by f2c (version 20100827).
...
static real c_b84 = 0.f;
static real c_b94 = 1.f;
...
/* Main program */ int MAIN__(void)
{
    ...
    static real w[130], aa[4225], ab[8450]	/* was [65][130] */, bb[4225],
    ...
    static logical ltest[6], sfatal;
    static char snamet[6], transa[1], transb[1];
    static real thresh;
    static logical ltestt, tsterr;
    static char summry[32];
    extern doublereal epsilon_(real *);
...
/*     the result computed by SMMCH. */
    ...
    *(unsigned char *)transb = 'N';
    smmch_(transa, transb, &n, &c__1, &n, &c_b94, ab, &c__65, &ab[4225], &
	    c__65, &c_b84, c__, &c__65, ct, g, cc, &c__65, &eps, &err, &fatal,
	...
	ftnlen sname_len)
{
    ...
    /* Local variables */
    static integer i__, k, m, n, ia, ib, ma, mb, na, nb, nc, ik, im, in, ks, 
	    ms, ns, ica, icb, laa, lbb, lda, lcc, ldb, ldc;
    static real als, bls;
    extern logical lse_(real *, real *, integer *);
    static real err, beta;
...
/*                 Generate the matrix A. */
		    ...
		    smake_("GE", " ", " ", &ma, &na, &a[a_offset], nmax, &aa[
			    1], &lda, &reset, &c_b84, (ftnlen)2, (ftnlen)1, (
			    ftnlen)1);
	...
	ftnlen sname_len)
{
    ...
    /* Local variables */
    static integer i__, m, n, ia, ib, na, nc, im, in, ms, ns, laa, lbb, lda, 
	    lcc, ldb, ldc, ics;
    static real als, bls;
    static integer icu;
    extern logical lse_(real *, real *, integer *);
...
/*           Generate the matrix B. */
	    ...
	    smake_("GE", " ", " ", &m, &n, &b[b_offset], nmax, &bb[1], &ldb, &
		    reset, &c_b84, (ftnlen)2, (ftnlen)1, (ftnlen)1);
	...
	ct, real *g, real *c__, ftnlen sname_len)
{
    ...
    /* Local variables */
    static integer i__, j, m, n, ia, na, nc, im, in, ms, ns, laa, icd, lbb, 
	    lda, ldb, ics;
    static real als;
	...
	ftnlen sname_len)
{
    ...
    /* Local variables */
    static integer i__, j, k, n, ia, ib, jc, ma, na, nc, ik, in, jj, lj, ks, 
	    ns, laa, lda, lcc, ldc;
    static real als;
    static integer ict, icu;
    extern logical lse_(real *, real *, integer *);
...
/*              Generate the matrix A. */
		...
		smake_("GE", " ", " ", &ma, &na, &a[a_offset], nmax, &aa[1], &
			lda, &reset, &c_b84, (ftnlen)2, (ftnlen)1, (ftnlen)1);
...
/*              Generate the matrix A. */
		...
		if (tran) {
		    ...
		    smake_("GE", " ", " ", &ma, &na, &ab[1], &i__3, &aa[1], &
			    lda, &reset, &c_b84, (ftnlen)2, (ftnlen)1, (
			    ftnlen)1);
		} else {
...
/*              Generate the matrix B. */
		...
		if (tran) {
		    ...
		    smake_("GE", " ", " ", &ma, &na, &ab[k + 1], &i__3, &bb[1]
			    , &ldb, &reset, &c_b84, (ftnlen)2, (ftnlen)1, (
			    ftnlen)1);
		} else {
		    smake_("GE", " ", " ", &ma, &na, &ab[k * *nmax + 1], nmax,
			     &bb[1], &ldb, &reset, &c_b84, (ftnlen)2, (ftnlen)
			    1, (ftnlen)1);
		}
	...
	ftnlen srnamt_len)
{
    ...
    /* Local variables */
    static real a[2]	/* was [2][1] */, b[2]	/* was [2][1] */, c__[2]	
	    /* was [2][1] */, beta, alpha;
	...
	diag_len)
{
    ...
    static logical unit, lower, upper;
	...
	real *as, integer *lda, ftnlen type_len, ftnlen uplo_len)
{
    ...
    /* Local variables */
    static integer i__, j, ibeg, iend;
    static logical upper;
