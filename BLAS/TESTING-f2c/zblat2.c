/* zblat2.f -- translated by f2c (version 20100827).
...
/* Main program */ int MAIN__(void)
{
    ...
    static doublecomplex x[65], y[65], z__[130], aa[4225];
    static integer kb[7];
    static doublecomplex as[4225], xs[130], ys[130], yt[65], xx[130], yy[130],
	     alf[7];
	...
	g, ftnlen sname_len)
{
    ...
    /* Local variables */
    static integer i__, m, n, ia, ib, ic, nc, nd, im, in, kl, ml, nk, nl, ku, 
	    ix, iy, ms, lx, ly, ns, laa, lda;
	...
	g, ftnlen sname_len)
{
    ...
    /* Local variables */
    static integer i__, k, n, ia, ib, ic, nc, ik, in, nk, ks, ix, iy, ns, lx, 
	    ly, laa, lda;
    static doublecomplex als, bls;
    static doublereal err;
    extern logical lze_(doublecomplex *, doublecomplex *, integer *);
	...
	doublereal *g, doublecomplex *z__, ftnlen sname_len)
{
    ...
    /* Local variables */
    static integer i__, k, n, nc, ik, in, nk, ks, ix, ns, lx, laa, icd, lda, 
	    ict, icu;
    static doublereal err;
    extern logical lze_(doublecomplex *, doublecomplex *, integer *);
    static char diag[1];
	...
	g, doublecomplex *z__, ftnlen sname_len)
{
    ...
    static doublecomplex w[1];
    static integer ia, nc, nd, im, in, ms, ix, iy, ns, lx, ly, laa, lda;
	...
	g, doublecomplex *z__, ftnlen sname_len)
{
    ...
    static integer i__, j, n;
    static doublecomplex w[1];
    static integer ia, ja, ic, nc, jj, lj, in, ix, ns, lx, laa, lda;
    static doublereal err;
    extern logical lze_(doublecomplex *, doublecomplex *, integer *);
    static integer ldas;
    static logical same;
	...
	g, doublecomplex *z__, ftnlen sname_len)
{
    ...
    static integer ia, ja, ic, nc, jj, lj, in, ix, iy, ns, lx, ly, laa, lda;
    static doublecomplex als;
    static doublereal err;
    extern logical lze_(doublecomplex *, doublecomplex *, integer *);
    static integer ldas;
	...
	ftnlen srnamt_len)
{
    ...
    /* Local variables */
    static doublecomplex a[1]	/* was [1][1] */, x[1], y[1], beta;
    extern /* Subroutine */ int zher_(char *, integer *, doublereal *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, ftnlen), 
	...
	*transl, ftnlen type_len, ftnlen uplo_len, ftnlen diag_len)
{
    ...
    /* Local variables */
    static integer i__, j, i1, i2, i3, jj, kk;
	...
	ftnlen trans_len)
{
    ...
    /* Local variables */
    static integer i__, j, ml, nl, iy, jx, kx, ky;
    static doublereal erri;
    static logical tran, ctran;
    static integer incxl, incyl;
