...
/* Main program */ int MAIN__(void)
{
    ...
    static doublereal x[65], y[65], z__[130], aa[4225];
    static integer kb[7];
    static doublereal as[4225], xs[130], ys[130], yt[65], xx[130], yy[130], 
	    alf[7];
    ...
    static logical ltest[16], sfatal;
	...
	doublereal *ys, doublereal *yt, doublereal *g, ftnlen sname_len)
{
    ...
    static integer i__, k, n, ia, ib, ic, nc, ik, in, nk, ks, ix, iy, ns, lx, 
	    ly, laa, lda;
    extern logical lde_(doublereal *, doublereal *, integer *);
    static doublereal als, bls, err, beta;
    static integer ldas;
    static logical same;
    static integer incx, incy;
	...
	ftnlen srnamt_len)
{
    ...
    /* Local variables */
    static doublereal a[1]	/* was [1][1] */, x[1], y[1], beta;
    extern /* Subroutine */ int dger_(integer *, integer *, doublereal *, 
	    doublereal *, integer *, doublereal *, integer *, doublereal *, 
	...
	ftnlen type_len, ftnlen uplo_len, ftnlen diag_len)
{
    ...
    /* Local variables */
    static integer i__, j, i1, i2, i3, kk;
