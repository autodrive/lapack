...
/* Main program */ int MAIN__(void)
{
    ...
    static doublecomplex w[130], aa[4225], ab[8450]	/* was [65][130] */, 
	    bb[4225], cc[4225], as[4225], bs[4225], cs[4225], ct[65], alf[7], 
	    bet[7];
	...
	ftnlen srnamt_len)
{
    ...
    /* Local variables */
    static doublecomplex a[2]	/* was [2][1] */, b[2]	/* was [2][1] */, c__[
	    2]	/* was [2][1] */, beta, alpha;
    static doublereal rbeta;
