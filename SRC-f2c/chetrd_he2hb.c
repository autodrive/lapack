/* chetrd_he2hb.f -- translated by f2c (version 20100827).
...
/* > */
/*  ===================================================================== */
/* Subroutine */ int chetrd_he2hb__(char *uplo, integer *n, integer *kd, 
	...
	complex *work, integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int cher2k_(char *, char *, integer *, integer *, 
	    ...
	    complex *, integer *, ftnlen, ftnlen), cgelqf_(integer *, integer 
	    *, complex *, integer *, complex *, complex *, integer *, integer 
	    *), cgeqrf_(integer *, integer *, complex *, integer *, complex *,
	     complex *, integer *, integer *), clarft_(char *, char *, 
	    integer *, integer *, complex *, integer *, complex *, complex *, 
	    integer *, ftnlen, ftnlen), claset_(char *, integer *, integer *, 
	    complex *, complex *, complex *, integer *, ftnlen), xerbla_(char 
	    *, integer *, ftnlen);
...
/*     and test the input parameters */
    ...
    *info = 0;
    ...
    lquery = *lwork == -1;
    lwmin = ilaenv_(&c__20, "CHETRD_HE2HB", "", n, kd, &c_n1, &c_n1, (ftnlen)
	    12, (ftnlen)0);
...
/*     way everytime T is generated the upper/lower portion will be always zero */
    ...
    claset_("A", &ldt, kd, &c_b1, &c_b1, &work[tpos], &ldt, (ftnlen)1);
