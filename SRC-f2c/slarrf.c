	...
	real *dplus, real *lplus, real *work, integer *info)
{
    ...
    /* Local variables */
    static integer i__;
    static real s, bestshift, smlgrowth, eps, tmp, max1, max2, rrr1, rrr2, 
	    znm2, growthbound, fail, fact, oldp;
    static integer indx;
    static real prod;
    static integer ktry;
    static real fail2, avgap, ldmax, rdmax;
    ...
    static real mingap, lsigma, rdelta;
    static logical forcer;
    static real rsigma, clwdth;
