...
/* Subroutine */ int sgesvj_(char *joba, char *jobu, char *jobv, integer *m, 
	...
	integer *ldv, real *work, integer *lwork, integer *info, ftnlen 
	joba_len, ftnlen jobu_len, ftnlen jobv_len)
{
    ...
    static real skl, tol;
    static integer mvl;
    static real aapp, aapq, aaqq, ctol;
    static integer ierr;
    extern doublereal sdot_(integer *, real *, integer *, real *, integer *);
    static real aapp0, temp1;
    extern doublereal snrm2_(integer *, real *, integer *);
    static real large, apoaq, aqoap;
    extern logical lsame_(char *, char *, ftnlen, ftnlen);
    static real theta;
    extern /* Subroutine */ int sscal_(integer *, real *, real *, integer *);
    static real small, sfmin;
    static logical lsvec;
    static real fastr[5], epsln;
    ...
    extern /* Subroutine */ int sswap_(integer *, real *, integer *, real *, 
	    ...
	    real *, integer *, real *, integer *, integer *, ftnlen), sgsvj1_(
...
/*     Undo scaling, if necessary (and possible). */
    if (skl > 1.f && sva[1] < big / skl || skl < 1.f && sva[max(n2,1)] > 
	    sfmin / skl) {
	i__1 = *n;
	for (p = 1; p <= i__1; ++p) {
	    sva[p] = skl * sva[p];
