...
/*           Set A(J, J+1) = T(J, J+1) */
	    ...
	    if (a[k + j * a_dim1] == 0. && a[k + (j + 1) * a_dim1] == 0. && (
		    k == 1 || a[k - 1 + j * a_dim1] == 0.)) {
		if (*info == 0) {
		    *info = j;
		}
	    }
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:M, J) = L(J+2:M, J+1) */
	    ...
	    if (a[k + j * a_dim1] == 0. && (k == 1 || a[j - 1 + j * a_dim1] ==
		     0.)) {
		if (*info == 0) {
		    *info = j;
		}
...
/*           Set A(J+1, J) = T(J+1, J) */
	    ...
	    if (a[j + k * a_dim1] == 0. && a[j + 1 + k * a_dim1] == 0. && (k 
		    == 1 || a[j + (k - 1) * a_dim1] == 0.)) {
		if (*info == 0) {
		    *info = j;
		}
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:M, J) = L(J+2:M, J+1) */
	    ...
	    if (a[j + k * a_dim1] == 0. && (k == 1 || a[j + (k - 1) * a_dim1] 
		    == 0.)) {
		if (*info == 0) {
		    *info = j;
		}
