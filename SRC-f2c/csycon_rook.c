/* csycon_rook.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int csycon_rook__(char *uplo, integer *n, complex *a, 
	...
	integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    static integer i__;
    extern /* Subroutine */ int csytrs_rook__(char *, integer *, integer *, 
...
/*        Multiply by inv(L*D*L**T) or inv(U*D*U**T). */
	...
	csytrs_rook__(uplo, n, &c__1, &a[a_offset], lda, &ipiv[1], &work[1], 
		n, info, (ftnlen)1);
	goto L30;
    }
