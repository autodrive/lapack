/* zhegv_2stage.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int zhegv_2stage__(integer *itype, char *jobz, char *uplo, 
	...
	*ldb, doublereal *w, doublecomplex *work, integer *lwork, doublereal *
	rwork, integer *info, ftnlen jobz_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int zheev_2stage__(char *, char *, integer *, 
...
/*     Test the input parameters. */
	...
	*info = -8;
    ...
    if (*info == 0) {
	kd = ilaenv_(&c__17, "ZHETRD_2STAGE", jobz, n, &c_n1, &c_n1, &c_n1, (
		ftnlen)13, (ftnlen)1);
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    zhegst_(itype, uplo, n, &a[a_offset], lda, &b[b_offset], ldb, info, (
	    ftnlen)1);
    zheev_2stage__(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, &
