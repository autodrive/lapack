...
/* Subroutine */ int sgsvj1_(char *jobv, integer *m, integer *n, integer *n1, 
	...
	real *work, integer *lwork, integer *info, ftnlen jobv_len)
{
    ...
    static real t, rootsfmin, cs, sn;
    static integer jbc;
    static real big;
    static integer kbl, igl, ibr, jgl, mvl, nblc;
    static real aapp, aapq, aaqq;
    ...
    static real theta, small, fastr[5];
    ...
    extern /* Subroutine */ int sswap_(integer *, real *, integer *, real *, 
	    ...
	    , real *), xerbla_(char *, integer *, ftnlen);
