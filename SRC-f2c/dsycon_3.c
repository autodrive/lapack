/* dsycon_3.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int dsycon_3__(char *uplo, integer *n, doublereal *a, 
...
/*        Multiply by inv(L*D*L**T) or inv(U*D*U**T). */
	...
	dsytrs_3__(uplo, n, &c__1, &a[a_offset], lda, &e[1], &ipiv[1], &work[
		1], n, info, (ftnlen)1);
	goto L30;
    }
