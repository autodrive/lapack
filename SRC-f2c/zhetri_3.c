/* zhetri_3.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int zhetri_3__(char *uplo, integer *n, doublecomplex *a, 
	...
	integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int zhetri_3x__(char *, integer *, doublecomplex *
...
/*     Quick return if possible */
    ...
    zhetri_3x__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], &nb, 
	    info, (ftnlen)1);
