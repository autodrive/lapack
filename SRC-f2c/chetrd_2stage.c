...
/*     Determine the block size, the workspace size and the hous size. */
    ...
    kd = ilaenv_(&c__17, "CHETRD_2STAGE", vect, n, &c_n1, &c_n1, &c_n1, (
	    ftnlen)13, (ftnlen)1);
    ib = ilaenv_(&c__18, "CHETRD_2STAGE", vect, n, &kd, &c_n1, &c_n1, (ftnlen)
	    13, (ftnlen)1);
    lhmin = ilaenv_(&c__19, "CHETRD_2STAGE", vect, n, &kd, &ib, &c_n1, (
	    ftnlen)13, (ftnlen)1);
    lwmin = ilaenv_(&c__20, "CHETRD_2STAGE", vect, n, &kd, &ib, &c_n1, (
	    ftnlen)13, (ftnlen)1);
