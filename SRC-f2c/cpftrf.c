/* cpftrf.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int cpftrf_(char *transr, char *uplo, integer *n, complex *a,
	 integer *info, ftnlen transr_len, ftnlen uplo_len)
{
...
/*             T1 -> a(0), T2 -> a(n), S -> a(n1) */
		...
		cpotrf_("L", &n1, a, n, info, (ftnlen)1);
		if (*info > 0) {
		    return 0;
		}
		...
		cherk_("U", "N", &n2, &n1, &c_b15, &a[n1], n, &c_b16, &a[*n], 
			n, (ftnlen)1, (ftnlen)1);
		cpotrf_("U", &n2, &a[*n], n, info, (ftnlen)1);
		if (*info > 0) {
		    *info += n1;
		}
...
/*             T1 -> a(n2), T2 -> a(n1), S -> a(0) */
		...
		cpotrf_("L", &n1, &a[n2], n, info, (ftnlen)1);
		if (*info > 0) {
		    return 0;
		}
		...
		cherk_("U", "C", &n2, &n1, &c_b15, a, n, &c_b16, &a[n1], n, (
			ftnlen)1, (ftnlen)1);
		cpotrf_("U", &n2, &a[n1], n, info, (ftnlen)1);
		if (*info > 0) {
		    *info += n1;
		}
...
/*              T1 -> a(0+0) , T2 -> a(1+0) , S -> a(0+n1*n1); lda=n1 */
		...
		cpotrf_("U", &n1, a, &n1, info, (ftnlen)1);
		if (*info > 0) {
		    return 0;
		}
		...
		cpotrf_("L", &n2, &a[1], &n1, info, (ftnlen)1);
		if (*info > 0) {
		    *info += n1;
		}
...
/*              T1 -> a(n2*n2), T2 -> a(n1*n2), S -> a(0); lda = n2 */
		...
		cpotrf_("U", &n1, &a[n2 * n2], &n2, info, (ftnlen)1);
		if (*info > 0) {
		    return 0;
		}
		...
		cpotrf_("L", &n2, &a[n1 * n2], &n2, info, (ftnlen)1);
		if (*info > 0) {
		    *info += n1;
		}
...
/*              T1 -> a(1), T2 -> a(0), S -> a(k+1) */
		...
		i__1 = *n + 1;
		cpotrf_("L", &k, &a[1], &i__1, info, (ftnlen)1);
		if (*info > 0) {
		    return 0;
		}
		i__1 = *n + 1;
		...
		i__1 = *n + 1;
		cpotrf_("U", &k, a, &i__1, info, (ftnlen)1);
		if (*info > 0) {
		    *info += k;
		}
...
/*              T1 -> a(k+1), T2 -> a(k), S -> a(0) */
		...
		i__1 = *n + 1;
		cpotrf_("L", &k, &a[k + 1], &i__1, info, (ftnlen)1);
		if (*info > 0) {
		    return 0;
		}
		i__1 = *n + 1;
		...
		cherk_("U", "C", &k, &k, &c_b15, a, &i__1, &c_b16, &a[k], &
			i__2, (ftnlen)1, (ftnlen)1);
		i__1 = *n + 1;
		cpotrf_("U", &k, &a[k], &i__1, info, (ftnlen)1);
		if (*info > 0) {
		    *info += k;
		}
...
/*              T1 -> a(0+k), T2 -> a(0+0), S -> a(0+k*(k+1)); lda=k */
		...
		cpotrf_("U", &k, &a[k], &k, info, (ftnlen)1);
		if (*info > 0) {
		    return 0;
		}
...
/*              T1 -> a(0+k*(k+1)), T2 -> a(0+k*k), S -> a(0+0)); lda=k */
		...
		cpotrf_("U", &k, &a[k * (k + 1)], &k, info, (ftnlen)1);
		if (*info > 0) {
		    return 0;
		}
		...
		cherk_("L", "N", &k, &k, &c_b15, a, &k, &c_b16, &a[k * k], &k,
			 (ftnlen)1, (ftnlen)1);
		cpotrf_("L", &k, &a[k * k], &k, info, (ftnlen)1);
		if (*info > 0) {
		    *info += k;
		}
