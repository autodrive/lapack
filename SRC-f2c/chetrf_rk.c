/* chetrf_rk.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int chetrf_rk__(char *uplo, integer *n, complex *a, integer *
	...
	integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int chetf2_rk__(char *, integer *, complex *, 
	    integer *, complex *, integer *, integer *, ftnlen);
    static integer i__, k;
    extern /* Subroutine */ int clahef_rk__(char *, integer *, integer *, 
...
/*           update columns 1:k-kb */
	    ...
	    clahef_rk__(uplo, &k, &nb, &kb, &a[a_offset], lda, &e[1], &ipiv[1]
		    , &work[1], &ldwork, &iinfo, (ftnlen)1);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    chetf2_rk__(uplo, &k, &a[a_offset], lda, &e[1], &ipiv[1], &iinfo, 
		    (ftnlen)1);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    clahef_rk__(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &e[k],
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    chetf2_rk__(uplo, &i__1, &a[k + k * a_dim1], lda, &e[k], &ipiv[k],
		     &iinfo, (ftnlen)1);
	    kb = *n - k + 1;
