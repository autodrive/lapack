/* zpbsv.f -- translated by f2c (version 20100827).
	...
	ldb, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *, ftnlen), zpbtrf_(
	    char *, integer *, integer *, doublecomplex *, integer *, integer 
	    *, ftnlen), zpbtrs_(char *, integer *, integer *, integer *, 
...
/*     Compute the Cholesky factorization A = U**H *U or A = L*L**H. */
    ...
    zpbtrf_(uplo, n, kd, &ab[ab_offset], ldab, info, (ftnlen)1);
    if (*info == 0) {
