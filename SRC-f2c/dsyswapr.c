/* dsyswapr.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dsyswap
r.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dsyswap
r.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dsyswap
r.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/* Subroutine */ int dsyswapr_(char *uplo, integer *n, doublereal *a, integer 
	*lda, integer *i1, integer *i2, ftnlen uplo_len)
{
...
/*          - swap column I1 and I2 from I1 to I1-1 */
	i__1 = *i1 - 1;
	dswap_(&i__1, &a[*i1 * a_dim1 + 1], &c__1, &a[*i2 * a_dim1 + 1], &
		c__1);
