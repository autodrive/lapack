/* dsysvx.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dsysvx.
f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dsysvx.
f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dsysvx.
f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	ftnlen fact_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int dsycon_(char *, integer *, doublereal *, 
	    ...
	    integer *, integer *, ftnlen), dsyrfs_(char *, integer *, integer 
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = dlansy_("I", uplo, n, &a[a_offset], lda, &work[1], (ftnlen)1, (
	    ftnlen)1);
