/* dggsvp3.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dggsvp3
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dggsvp3
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dggsvp3
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	ftnlen jobv_len, ftnlen jobq_len)
{
    ...
    extern /* Subroutine */ int dgeqp3_(integer *, integer *, doublereal *, 
	    ...
	    integer *), dorg2r_(integer *, integer *, integer *, doublereal *,
	     integer *, doublereal *, doublereal *, integer *), dorm2r_(char *
	    , char *, integer *, integer *, integer *, doublereal *, integer *
	    , doublereal *, doublereal *, integer *, doublereal *, integer *, 
	    ftnlen, ftnlen), dormr2_(char *, char *, integer *, integer *, 
	    integer *, doublereal *, integer *, doublereal *, doublereal *, 
	    integer *, doublereal *, integer *, ftnlen, ftnlen), dlacpy_(char 
...
/*     Compute workspace */
    ...
    if (*info == 0) {
	dgeqp3_(p, n, &b[b_offset], ldb, &iwork[1], &tau[1], &work[1], &c_n1, 
		info);
...
/* Computing MAX */
	...
	dgeqp3_(m, n, &a[a_offset], lda, &iwork[1], &tau[1], &work[1], &c_n1, 
		info);
/* Computing MAX */
...
/* L10: */
    ...
    dgeqp3_(p, n, &b[b_offset], ldb, &iwork[1], &tau[1], &work[1], lwork, 
	    info);
...
/*        Copy the details of V, and form V. */
	...
	dlaset_("Full", p, p, &c_b14, &c_b14, &v[v_offset], ldv, (ftnlen)4);
	if (*p > 1) {
	    i__1 = *p - 1;
...
/* L40: */
    ...
    if (*p > *l) {
	i__1 = *p - *l;
	dlaset_("Full", &i__1, n, &c_b14, &c_b14, &b[*l + 1 + b_dim1], ldb, (
		ftnlen)4);
    }
...
/*        Set Q = I and Update Q := Q*P */
	...
	dlaset_("Full", n, n, &c_b14, &c_b24, &q[q_offset], ldq, (ftnlen)4);
...
/*        Clean up B */
	...
	i__1 = *n - *l;
	dlaset_("Full", l, &i__1, &c_b14, &c_b14, &b[b_offset], ldb, (ftnlen)
		4);
	i__1 = *n;
...
/* L70: */
    ...
    i__1 = *n - *l;
    dgeqp3_(m, &i__1, &a[a_offset], lda, &iwork[1], &tau[1], &work[1], lwork, 
	    info);
...
/*        Copy the details of U, and form U */
	...
	dlaset_("Full", m, m, &c_b14, &c_b14, &u[u_offset], ldu, (ftnlen)4);
	if (*m > 1) {
	    i__1 = *m - 1;
	    i__2 = *n - *l;
...
/* L100: */
	...
	i__1 = *m - *k;
	i__2 = *n - *l;
	dlaset_("Full", &i__1, &i__2, &c_b14, &c_b14, &a[*k + 1 + a_dim1], 
		lda, (ftnlen)4);
    }
...
/*        Clean up A */
	...
	i__1 = *n - *l - *k;
	dlaset_("Full", k, &i__1, &c_b14, &c_b14, &a[a_offset], lda, (ftnlen)
		4);
	i__1 = *n - *l;
