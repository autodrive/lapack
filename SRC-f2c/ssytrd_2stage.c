/* ssytrd_2stage.f -- translated by f2c (version 20100827).
...
/* > */
/*  ===================================================================== */
/* Subroutine */ int ssytrd_2stage__(char *vect, char *uplo, integer *n, real 
	*a, integer *lda, real *d__, real *e, real *tau, real *hous2, integer 
	*lhous2, real *work, integer *lwork, integer *info, ftnlen vect_len, 
	ftnlen uplo_len)
{
...
/*     Determine the block size, the workspace size and the hous size. */
    ...
    kd = ilaenv_(&c__17, "SSYTRD_2STAGE", vect, n, &c_n1, &c_n1, &c_n1, (
	    ftnlen)13, (ftnlen)1);
    ib = ilaenv_(&c__18, "SSYTRD_2STAGE", vect, n, &kd, &c_n1, &c_n1, (ftnlen)
	    13, (ftnlen)1);
    lhmin = ilaenv_(&c__19, "SSYTRD_2STAGE", vect, n, &kd, &ib, &c_n1, (
	    ftnlen)13, (ftnlen)1);
    lwmin = ilaenv_(&c__20, "SSYTRD_2STAGE", vect, n, &kd, &ib, &c_n1, (
	    ftnlen)13, (ftnlen)1);
...
/*     Determine pointer position */
    ...
    abpos = 1;
    wpos = abpos + ldab * *n;
    ssytrd_sy2sb__(uplo, n, &kd, &a[a_offset], lda, &work[abpos], &ldab, &tau[
    ...
    ssytrd_sb2st__("Y", vect, uplo, n, &kd, &work[abpos], &ldab, &d__[1], &e[
