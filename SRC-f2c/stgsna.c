...
/* Subroutine */ int stgsna_(char *job, char *howmny, logical *select, 
	...
	info, ftnlen job_len, ftnlen howmny_len)
{
    ...
    static real eps, beta, cond;
    static logical pair;
    static integer ierr;
    static real uhav, uhbv;
    static integer ifst;
    static real lnrm;
    ...
    static real root1, root2, scale;
    extern logical lsame_(char *, char *, ftnlen, ftnlen);
    static real uhavi, uhbvi;
