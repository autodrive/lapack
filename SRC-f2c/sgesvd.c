...
/* Subroutine */ int sgesvd_(char *jobu, char *jobvt, integer *m, integer *n, 
	...
	integer *ldvt, real *work, integer *lwork, integer *info, ftnlen 
	jobu_len, ftnlen jobvt_len)
{
    ...
    extern /* Subroutine */ int sgelqf_(integer *, integer *, real *, integer 
	    ...
	    *, integer *, integer *, real *, integer *, real *, integer *, 
	    ...
	    real *, integer *, ftnlen), sbdsqr_(char *, integer *, integer *, 
	    integer *, integer *, real *, real *, real *, integer *, real *, 
	    integer *, real *, integer *, real *, integer *, ftnlen), sorgbr_(
	    char *, integer *, integer *, integer *, real *, integer *, real *
	    , real *, integer *, integer *, ftnlen), sormbr_(char *, char *, 
	    char *, integer *, integer *, integer *, real *, integer *, real *
	    , real *, integer *, real *, integer *, integer *, ftnlen, ftnlen,
	     ftnlen);
