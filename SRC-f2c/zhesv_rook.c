/* zhesv_rook.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int zhesv_rook__(char *uplo, integer *n, integer *nrhs, 
	...
	ftnlen uplo_len)
{
    ...
    /* Local variables */
    static integer nb;
    extern /* Subroutine */ int zhetrf_rook__(char *, integer *, 
	    doublecomplex *, integer *, integer *, doublecomplex *, integer *,
	     integer *, ftnlen), zhetrs_rook__(char *, integer *, integer *, 
	    doublecomplex *, integer *, integer *, doublecomplex *, integer *,
	     integer *, ftnlen);
...
/*     Compute the factorization A = U*D*U**H or A = L*D*L**H. */
    ...
    zhetrf_rook__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info,
	     (ftnlen)1);
    if (*info == 0) {
...
/*        Solve with TRS ( Use Level BLAS 2) */
	...
	zhetrs_rook__(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset]
		, ldb, info, (ftnlen)1);
