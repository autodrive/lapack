/* sposvxx.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/sposvxx
.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/sposvxx
.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/sposvxx
.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/* Subroutine */ int sposvxx_(char *fact, char *uplo, integer *n, integer *
	...
	params, real *work, integer *iwork, integer *info, ftnlen fact_len, 
	ftnlen uplo_len, ftnlen equed_len)
{
    ...
    extern /* Subroutine */ int slaqsy_(char *, integer *, real *, integer *, 
	    real *, real *, real *, char *, ftnlen, ftnlen), spotrf_(char *, 
	    integer *, real *, integer *, integer *, ftnlen), spotrs_(char *, 
	    integer *, integer *, real *, integer *, real *, integer *, 
	    integer *, ftnlen), slascl2_(integer *, integer *, real *, real *,
