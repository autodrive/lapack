/* spbsvx.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/spbsvx.
f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/spbsvx.
f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/spbsvx.
f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	integer *info, ftnlen fact_len, ftnlen uplo_len, ftnlen equed_len)
{
    ...
    extern /* Subroutine */ int spbcon_(char *, integer *, integer *, real *, 
	    integer *, real *, real *, real *, integer *, integer *, ftnlen), 
	    slaqsb_(char *, integer *, integer *, real *, integer *, real *, 
	    real *, real *, char *, ftnlen, ftnlen);
    static integer infequ;
    extern /* Subroutine */ int slacpy_(char *, integer *, integer *, real *, 
	    integer *, real *, integer *, ftnlen), spbequ_(char *, integer *, 
	    integer *, real *, integer *, real *, real *, real *, integer *, 
	    ftnlen), spbrfs_(char *, integer *, integer *, integer *, real *, 
	    integer *, real *, integer *, real *, integer *, real *, integer *
	    , real *, real *, real *, integer *, integer *, ftnlen), spbtrf_(
...
/* L50: */
	...
	spbtrf_(uplo, n, kd, &afb[afb_offset], ldafb, info, (ftnlen)1);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = slansb_("1", uplo, n, kd, &ab[ab_offset], ldab, &work[1], (ftnlen)
	    1, (ftnlen)1);
