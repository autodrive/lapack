/* zsytri2.f -- translated by f2c (version 20100827).
...
/*     Test the input parameters. */
    ...
    *info = 0;
    ...
    lquery = *lwork == -1;
/*     Get blocksize */
    nbmax = ilaenv_(&c__1, "ZSYTRF", uplo, n, &c_n1, &c_n1, &c_n1, (ftnlen)6, 
	    (ftnlen)1);
    if (nbmax >= *n) {
	minsize = *n;
    } else {
...
/*     Quick return if possible */
    ...
    if (nbmax >= *n) {
	zsytri_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], info, (ftnlen)
		1);
    } else {
