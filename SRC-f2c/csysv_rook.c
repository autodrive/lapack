/* csysv_rook.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int csysv_rook__(char *uplo, integer *n, integer *nrhs, 
	...
	complex *work, integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int csytrf_rook__(char *, integer *, complex *, 
	    integer *, integer *, complex *, integer *, integer *, ftnlen), 
	    csytrs_rook__(char *, integer *, integer *, complex *, integer *, 
...
/*     Test the input parameters. */
	...
	*info = -10;
	...
	if (*n == 0) {
	    ...
	    csytrf_rook__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &
		    c_n1, info, (ftnlen)1);
	    lwkopt = work[1].r;
	}
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    csytrf_rook__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info,
	     (ftnlen)1);
    if (*info == 0) {
...
/*        Solve with TRS_ROOK ( Use Level 2 BLAS) */
	...
	csytrs_rook__(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset]
		, ldb, info, (ftnlen)1);
