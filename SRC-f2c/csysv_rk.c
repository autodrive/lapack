/* csysv_rk.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int csysv_rk__(char *uplo, integer *n, integer *nrhs, 
	...
	uplo_len)
{
    ...
    extern /* Subroutine */ int csytrs_3__(char *, integer *, integer *, 
	    ...
	    integer *, ftnlen), csytrf_rk__(char *, integer *, complex *, 
...
/*     Test the input parameters. */
	...
	*info = -11;
	...
	if (*n == 0) {
	    ...
	    csytrf_rk__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1],
		     &c_n1, info, (ftnlen)1);
	    lwkopt = work[1].r;
	}
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    csytrf_rk__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], lwork, 
	    info, (ftnlen)1);
...
/*        Solve the system A*X = B with BLAS3 solver, overwriting B with X. */
	...
	csytrs_3__(uplo, n, nrhs, &a[a_offset], lda, &e[1], &ipiv[1], &b[
