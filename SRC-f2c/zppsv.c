/* zppsv.f -- translated by f2c (version 20100827).
	...
	ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *, ftnlen), zpptrf_(
	    char *, integer *, doublecomplex *, integer *, ftnlen), zpptrs_(
...
/*     Compute the Cholesky factorization A = U**H *U or A = L*L**H. */
    ...
    zpptrf_(uplo, n, &ap[1], info, (ftnlen)1);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	zpptrs_(uplo, n, nrhs, &ap[1], &b[b_offset], ldb, info, (ftnlen)1);
