/* dsysv.f -- translated by f2c (version 20100827).
	...
	doublereal *work, integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int dsytrs_(char *, integer *, integer *, 
	    ...
	    integer *, ftnlen), dsytrs2_(char *, integer *, integer *, 
	    doublereal *, integer *, integer *, doublereal *, integer *, 
...
/*     Test the input parameters. */
	...
	*info = -10;
	...
	if (*n == 0) {
	    ...
	    dsytrf_(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &c_n1, 
		    info, (ftnlen)1);
...
/*        Solve with TRS ( Use Level BLAS 2) */
	    ...
	    dsytrs_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
		    ldb, info, (ftnlen)1);
...
/*        Solve with TRS2 ( Use Level BLAS 3) */
	    ...
	    dsytrs2_(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset],
