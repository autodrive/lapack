/* csytrf_rk.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int csytrf_rk__(char *uplo, integer *n, complex *a, integer *
	...
	integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int csytf2_rk__(char *, integer *, complex *, 
	    integer *, complex *, integer *, integer *, ftnlen), clasyf_rk__(
...
/*           update columns 1:k-kb */
	    ...
	    clasyf_rk__(uplo, &k, &nb, &kb, &a[a_offset], lda, &e[1], &ipiv[1]
		    , &work[1], &ldwork, &iinfo, (ftnlen)1);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    csytf2_rk__(uplo, &k, &a[a_offset], lda, &e[1], &ipiv[1], &iinfo, 
		    (ftnlen)1);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    clasyf_rk__(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &e[k],
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    csytf2_rk__(uplo, &i__1, &a[k + k * a_dim1], lda, &e[k], &ipiv[k],
		     &iinfo, (ftnlen)1);
	    kb = *n - k + 1;
