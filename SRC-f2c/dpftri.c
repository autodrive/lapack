/* dpftri.f -- translated by f2c (version 20100827).
	...
	*a, integer *info, ftnlen transr_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int dlauum_(char *, integer *, doublereal *, 
	    integer *, integer *, ftnlen), dtftri_(char *, char *, char *, 
...
/*     Invert the triangular Cholesky factor U or L. */
    ...
    dtftri_(transr, uplo, "N", n, a, info, (ftnlen)1, (ftnlen)1, (ftnlen)1);
    if (*info > 0) {
	return 0;
    }
...
/*              T1 -> a(0), T2 -> a(1), S -> a(0+N1*N1) */
		...
		dlauum_("U", &n1, a, &n1, info, (ftnlen)1);
		...
		dtrmm_("R", "L", "N", "N", &n1, &n2, &c_b11, &a[1], &n1, &a[
			...
			ftnlen)1);
		dlauum_("L", &n2, &a[1], &n1, info, (ftnlen)1);
...
/*              T1 -> a(0+N2*N2), T2 -> a(0+N1*N2), S -> a(0) */
		...
		dlauum_("U", &n1, &a[n2 * n2], &n2, info, (ftnlen)1);
		...
		dlauum_("L", &n2, &a[n1 * n2], &n2, info, (ftnlen)1);
...
/*              T1 -> a(1), T2 -> a(0), S -> a(k+1) */
		...
		i__1 = *n + 1;
		dlauum_("L", &k, &a[1], &i__1, info, (ftnlen)1);
		i__1 = *n + 1;
		i__2 = *n + 1;
		...
		i__1 = *n + 1;
		dlauum_("U", &k, a, &i__1, info, (ftnlen)1);
...
/*              T1 -> a(k+1), T2 -> a(k), S -> a(0) */
		...
		i__1 = *n + 1;
		dlauum_("L", &k, &a[k + 1], &i__1, info, (ftnlen)1);
		i__1 = *n + 1;
		i__2 = *n + 1;
		...
		dtrmm_("R", "U", "T", "N", &k, &k, &c_b11, &a[k], &i__1, a, &
			i__2, (ftnlen)1, (ftnlen)1, (ftnlen)1, (ftnlen)1);
		i__1 = *n + 1;
		dlauum_("U", &k, &a[k], &i__1, info, (ftnlen)1);
...
/*              T1 -> a(0+k), T2 -> a(0+0), S -> a(0+k*(k+1)); lda=k */
		...
		dlauum_("U", &k, &a[k], &k, info, (ftnlen)1);
