	...
	integer *info, ftnlen side_len, ftnlen howmny_len)
{
    ...
    extern /* Subroutine */ int slaset_(char *, integer *, integer *, real *, 
	    real *, real *, integer *, ftnlen), slacpy_(char *, integer *, 
...
/*                    Scale if necessary */
			...
			work[j + iv * *n] = x[0];
/* Computing MAX */
			r__2 = (r__1 = work[j + iv * *n], dabs(r__1));
			vmax = dmax(r__2,vmax);
			vcrit = bignum / vmax;
...
/* Computing MAX */
			r__3 = (r__1 = work[j + iv * *n], dabs(r__1)), r__4 = 
				(r__2 = work[j + 1 + iv * *n], dabs(r__2)), 
				r__3 = max(r__3,r__4);
			vmax = dmax(r__3,vmax);
			vcrit = bignum / vmax;
