/* ssytri_3.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int ssytri_3__(char *uplo, integer *n, real *a, integer *lda,
	...
	ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ssytri_3x__(char *, integer *, real *, 
...
/*     Quick return if possible */
    ...
    ssytri_3x__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], &nb, 
	    info, (ftnlen)1);
