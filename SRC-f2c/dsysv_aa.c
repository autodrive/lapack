/* dsysv_aa.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int dsysv_aa__(char *uplo, integer *n, integer *nrhs, 
	...
	ldb, doublereal *work, integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int dsytrf_aa__(char *, integer *, doublereal *, 
	    integer *, integer *, doublereal *, integer *, integer *, ftnlen),
	     dsytrs_aa__(char *, integer *, integer *, doublereal *, integer *
...
/* Computing MAX */
    ...
    if (*info == 0) {
	dsytrf_aa__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &c_n1, 
		info, (ftnlen)1);
	lwkopt_sytrf__ = (integer) work[1];
	dsytrs_aa__(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
...
/*     Compute the factorization A = U*T*U**T or A = L*T*L**T. */
    ...
    dsytrf_aa__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info, (
	    ftnlen)1);
    if (*info == 0) {
