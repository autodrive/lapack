...
/*  ===================================================================== */
/* Subroutine */ int sggev3_(char *jobvl, char *jobvr, integer *n, real *a, 
	...
	integer *lwork, integer *info, ftnlen jobvl_len, ftnlen jobvr_len)
{
    ...
    extern /* Subroutine */ int sgghd3_(char *, char *, integer *, integer *, 
	    ...
	    , slabad_(real *, real *), sggbak_(char *, char *, integer *, 
	    integer *, integer *, real *, real *, integer *, real *, integer *
	    , integer *, ftnlen, ftnlen), sggbal_(char *, integer *, real *, 
    ...
    extern /* Subroutine */ int slacpy_(char *, integer *, integer *, real *, 
	    ...
	    integer *, real *, real *, real *, integer *, ftnlen), stgevc_(
