...
/*        Find max(abs(A(i,j))). */
	...
	for (i__ = 1; i__ <= i__1; ++i__) {
	    r__3 = (r__2 = dl[i__], dabs(r__2));
	    if (anorm < (r__1 = dl[i__], dabs(r__1)) || sisnan_(&r__3)) {
		anorm = (r__4 = dl[i__], dabs(r__4));
	    }
	    r__3 = (r__2 = d__[i__], dabs(r__2));
	    if (anorm < (r__1 = d__[i__], dabs(r__1)) || sisnan_(&r__3)) {
		anorm = (r__4 = d__[i__], dabs(r__4));
	    }
	    r__3 = (r__2 = du[i__], dabs(r__2));
	    if (anorm < (r__1 = du[i__], dabs(r__1)) || sisnan_(&r__3)) {
		anorm = (r__4 = du[i__], dabs(r__4));
	    }
/* L10: */
	}
...
/*        Find norm1(A). */
	...
	if (*n == 1) {
	    ...
	    anorm = dabs(d__[1]) + dabs(dl[1]);
	    temp = (r__1 = d__[*n], dabs(r__1)) + (r__2 = du[*n - 1], dabs(
		    r__2));
		...
		temp = (r__1 = d__[i__], dabs(r__1)) + (r__2 = dl[i__], dabs(
			r__2)) + (r__3 = du[i__ - 1], dabs(r__3));
		if (anorm < temp || sisnan_(&temp)) {
		    anorm = temp;
		}
/* L20: */
...
/*        Find normI(A). */
	...
	if (*n == 1) {
	    ...
	    anorm = dabs(d__[1]) + dabs(du[1]);
	    temp = (r__1 = d__[*n], dabs(r__1)) + (r__2 = dl[*n - 1], dabs(
		    r__2));
	    if (anorm < temp || sisnan_(&temp)) {
		anorm = temp;
	    }
	    i__1 = *n - 1;
	    for (i__ = 2; i__ <= i__1; ++i__) {
		temp = (r__1 = d__[i__], dabs(r__1)) + (r__2 = du[i__], dabs(
			r__2)) + (r__3 = dl[i__ - 1], dabs(r__3));
		if (anorm < temp || sisnan_(&temp)) {
		    anorm = temp;
		}
/* L30: */
