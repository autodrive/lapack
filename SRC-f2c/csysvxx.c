/* csysvxx.f -- translated by f2c (version 20100827).
	...
	ftnlen fact_len, ftnlen uplo_len, ftnlen equed_len)
{
    ...
    extern /* Subroutine */ int claqsy_(char *, integer *, complex *, integer 
	    *, real *, real *, real *, char *, ftnlen, ftnlen), csytrf_(char *
    ...
    extern /* Subroutine */ int clascl2_(integer *, integer *, real *, 
	    ...
	    ftnlen), csyequb_(char *, integer *, complex *, integer *, real *,
	     real *, real *, complex *, integer *, ftnlen), csyrfsx_(char *, 
	    char *, integer *, integer *, complex *, integer *, complex *, 
	    integer *, integer *, real *, complex *, integer *, complex *, 
	    integer *, real *, real *, integer *, real *, real *, integer *, 
	    real *, complex *, real *, integer *, ftnlen, ftnlen);
