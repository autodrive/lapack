/* zhesv_rk.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int zhesv_rk__(char *uplo, integer *n, integer *nrhs, 
	...
	integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int zhetrs_3__(char *, integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, integer *, integer *, ftnlen), zhetrf_rk__(char *
...
/*     Test the input parameters. */
	...
	*info = -11;
	...
	if (*n == 0) {
	    ...
	    zhetrf_rk__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1],
		     &c_n1, info, (ftnlen)1);
...
/*     A = P*U*D*(U**H)*(P**T). */
    ...
    zhetrf_rk__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], lwork, 
	    info, (ftnlen)1);
...
/*        Solve the system A*X = B with BLAS3 solver, overwriting B with X. */
	...
	zhetrs_3__(uplo, n, nrhs, &a[a_offset], lda, &e[1], &ipiv[1], &b[
