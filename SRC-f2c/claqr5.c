...
/* Computing MIN */
			...
			i__6 = m22 * v_dim1 + 2;
			i__8 = j + (k + 2) * h_dim1;
			q__3.r = v[i__6].r * h__[i__8].r - v[i__6].i * h__[
				i__8].i, q__3.i = v[i__6].r * h__[i__8].i + v[
				i__6].i * h__[i__8].r;
			q__2.r = h__[i__4].r + q__3.r, q__2.i = h__[i__4].i + 
				q__3.i;
			q__1.r = v[i__7].r * q__2.r - v[i__7].i * q__2.i, 
				q__1.i = v[i__7].r * q__2.i + v[i__7].i * 
				q__2.r;
			refsum.r = q__1.r, refsum.i = q__1.i;
			i__7 = j + (k + 1) * h_dim1;
			i__4 = j + (k + 1) * h_dim1;
...
/* Computing MAX */
			...
			for (j = max(i__5,i__7); j <= i__4; ++j) {
			    ...
			    i__6 = m22 * v_dim1 + 2;
			    i__8 = j + (kms + 2) * u_dim1;
			    q__3.r = v[i__6].r * u[i__8].r - v[i__6].i * u[
				    i__8].i, q__3.i = v[i__6].r * u[i__8].i + 
				    v[i__6].i * u[i__8].r;
...
/* L100: */
			...
			for (j = *iloz; j <= i__4; ++j) {
			    ...
			    i__6 = m22 * v_dim1 + 2;
			    i__8 = j + (k + 2) * z_dim1;
			    q__3.r = v[i__6].r * z__[i__8].r - v[i__6].i * 
				    z__[i__8].i, q__3.i = v[i__6].r * z__[
				    i__8].i + v[i__6].i * z__[i__8].r;
			    q__2.r = z__[i__7].r + q__3.r, q__2.i = z__[i__7]
				    .i + q__3.i;
			    q__1.r = v[i__5].r * q__2.r - v[i__5].i * q__2.i, 
				    q__1.i = v[i__5].r * q__2.i + v[i__5].i * 
				    q__2.r;
			    ...
			    i__5 = j + (k + 1) * z_dim1;
			    i__7 = j + (k + 1) * z_dim1;
			    q__1.r = z__[i__7].r - refsum.r, q__1.i = z__[
				    i__7].i - refsum.i;
			    ...
			    q__2.r = refsum.r * q__3.r - refsum.i * q__3.i, 
				    q__2.i = refsum.r * q__3.i + refsum.i * 
				    q__3.r;
			    q__1.r = z__[i__7].r - q__2.r, q__1.i = z__[i__7]
				    .i - q__2.i;
			    z__[i__5].r = q__1.r, z__[i__5].i = q__1.i;
/* L110: */
			}
