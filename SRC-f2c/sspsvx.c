/* sspsvx.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int sspsvx_(char *fact, char *uplo, integer *n, integer *
	...
	*x, integer *ldx, real *rcond, real *ferr, real *berr, real *work, 
	integer *iwork, integer *info, ftnlen fact_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int sspcon_(char *, integer *, real *, integer *, 
	    real *, real *, real *, integer *, integer *, ftnlen), ssprfs_(
	    char *, integer *, integer *, real *, real *, integer *, real *, 
	    integer *, real *, integer *, real *, real *, real *, integer *, 
	    integer *, ftnlen), ssptrf_(char *, integer *, real *, integer *, 
	    integer *, ftnlen), ssptrs_(char *, integer *, integer *, real *, 
...
/*        Compute the factorization A = U*D*U**T or A = L*D*L**T. */
	...
	ssptrf_(uplo, n, &afp[1], &ipiv[1], info, (ftnlen)1);
