...
/* Subroutine */ int cgesvj_(char *joba, char *jobu, char *jobv, integer *m, 
	...
	*v, integer *ldv, complex *cwork, integer *lwork, real *rwork, 
	integer *lrwork, integer *info, ftnlen joba_len, ftnlen jobu_len, 
	ftnlen jobv_len)
{
    ...
    static real aapp;
    static complex aapq;
    static real aaqq, ctol;
    static integer ierr;
    extern /* Subroutine */ int crot_(integer *, complex *, integer *, 
	    complex *, integer *, real *, complex *);
    static complex ompq;
    static real aapp0, aapq1, temp1;
    extern /* Complex */ VOID cdotc_(complex *, integer *, complex *, integer 
	    *, complex *, integer *);
    static real apoaq, aqoap;
    extern logical lsame_(char *, char *, ftnlen, ftnlen);
    static real theta, small, sfmin;
    ...
    extern /* Subroutine */ int classq_(integer *, complex *, integer *, real 
	    *, real *);
    static real mxaapq, thsign, mxsinj;
