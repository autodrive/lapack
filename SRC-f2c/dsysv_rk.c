/* dsysv_rk.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int dsysv_rk__(char *uplo, integer *n, integer *nrhs, 
	...
	ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int dsytrs_3__(char *, integer *, integer *, 
	    doublereal *, integer *, doublereal *, integer *, doublereal *, 
	    integer *, integer *, ftnlen), dsytrf_rk__(char *, integer *, 
	    doublereal *, integer *, doublereal *, integer *, doublereal *, 
...
/*     Test the input parameters. */
	...
	*info = -11;
	...
	if (*n == 0) {
	    ...
	    dsytrf_rk__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1],
		     &c_n1, info, (ftnlen)1);
...
/*     A = P*U*D*(U**T)*(P**T). */
    ...
    dsytrf_rk__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], lwork, 
	    info, (ftnlen)1);
...
/*        Solve the system A*X = B with BLAS3 solver, overwriting B with X. */
	...
	dsytrs_3__(uplo, n, nrhs, &a[a_offset], lda, &e[1], &ipiv[1], &b[
