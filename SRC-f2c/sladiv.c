	...
	real *q)
{
    ...
    /* Local variables */
    static real s, aa, ab, bb, cc, cd, dd, be, un, ov, eps;
...
{
    static real r__, t;
    extern doublereal sladiv2_(real *, real *, real *, real *, real *, real *)
	    ;
...
/* > \ingroup realOTHERauxiliary */
doublereal sladiv2_(real *a, real *b, real *c__, real *d__, real *r__, real *
	t)
{
    /* System generated locals */
    real ret_val;
