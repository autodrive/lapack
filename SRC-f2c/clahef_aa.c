...
/* Subroutine */ int clahef_aa__(char *uplo, integer *j1, integer *m, integer 
	*nb, complex *a, integer *lda, integer *ipiv, complex *h__, integer *
	ldh, complex *work, integer *info, ftnlen uplo_len)
{
...
/*           first column */
	    ...
	    cgemv_("No transpose", &i__1, &i__2, &q__1, &h__[j + k1 * h_dim1],
...
/*           Set A(J, J+1) = T(J, J+1) */
	    ...
	    i__2 = k + (j + 1) * a_dim1;
	    i__3 = k - 1 + j * a_dim1;
	    if (a[i__1].r == 0.f && a[i__1].i == 0.f && (a[i__2].r == 0.f && 
		    a[i__2].i == 0.f) && (k == 1 || a[i__3].r == 0.f && a[
		    i__3].i == 0.f)) {
		if (*info == 0) {
		    *info = j;
		}
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:N, J) = L(J+2:N, J+1) */
	    ...
	    i__1 = k + j * a_dim1;
	    i__2 = j - 1 + j * a_dim1;
	    if (a[i__1].r == 0.f && a[i__1].i == 0.f && (k == 1 || a[i__2].r 
		    == 0.f && a[i__2].i == 0.f)) {
		if (*info == 0) {
		    *info = j;
		}
