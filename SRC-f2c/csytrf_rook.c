/* csytrf_rook.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int csytrf_rook__(char *uplo, integer *n, complex *a, 
	...
	info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int csytf2_rook__(char *, integer *, complex *, 
	    integer *, integer *, integer *, ftnlen), clasyf_rook__(char *, 
...
/*           update columns 1:k-kb */
	    ...
	    clasyf_rook__(uplo, &k, &nb, &kb, &a[a_offset], lda, &ipiv[1], &
		    work[1], &ldwork, &iinfo, (ftnlen)1);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    csytf2_rook__(uplo, &k, &a[a_offset], lda, &ipiv[1], &iinfo, (
		    ftnlen)1);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    clasyf_rook__(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    csytf2_rook__(uplo, &i__1, &a[k + k * a_dim1], lda, &ipiv[k], &
		    iinfo, (ftnlen)1);
	    kb = *n - k + 1;
	}
