	...
	integer *rank, real *work, integer *lwork, integer *info)
{
    ...
    extern /* Subroutine */ int strsm_(char *, char *, char *, char *, 
	    ...
	    , ftnlen, ftnlen, ftnlen, ftnlen), slaic1_(integer *, integer *, 
    ...
    extern /* Subroutine */ int sormqr_(char *, char *, integer *, integer *, 
	    ...
	    integer *, integer *, ftnlen, ftnlen), sormrz_(char *, char *, 
	    integer *, integer *, integer *, integer *, real *, integer *, 
	    real *, real *, integer *, real *, integer *, integer *, ftnlen, 
	    ftnlen), stzrzf_(integer *, integer *, real *, integer *, real *, 
