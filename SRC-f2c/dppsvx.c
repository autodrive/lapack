/* dppsvx.f -- translated by f2c (version 20100827).
	...
	equed_len)
{
    ...
    extern /* Subroutine */ int dppcon_(char *, integer *, doublereal *, 
	    ...
	    ftnlen), dlaqsp_(char *, integer *, doublereal *, doublereal *, 
    ...
    extern /* Subroutine */ int dppequ_(char *, integer *, doublereal *, 
	    ...
	    dpptrf_(char *, integer *, doublereal *, integer *, ftnlen);
...
/*        Compute row and column scalings to equilibrate the matrix A. */
	...
	dppequ_(uplo, n, &ap[1], &s[1], &scond, &amax, &infequ, (ftnlen)1);
	if (infequ == 0) {

/*           Equilibrate the matrix. */

	    dlaqsp_(uplo, n, &ap[1], &s[1], &scond, &amax, equed, (ftnlen)1, (
		    ftnlen)1);
	    rcequ = lsame_(equed, "Y", (ftnlen)1, (ftnlen)1);
	}
    }
...
/*        Compute the Cholesky factorization A = U**T * U or A = L * L**T. */
	...
	dpptrf_(uplo, n, &afp[1], info, (ftnlen)1);
...
/*     Compute the solution matrix X. */
    ...
    dpptrs_(uplo, n, nrhs, &afp[1], &x[x_offset], ldx, info, (ftnlen)1);
