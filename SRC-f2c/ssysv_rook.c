/* ssysv_rook.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int ssysv_rook__(char *uplo, integer *n, integer *nrhs, real 
	...
	integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ssytrf_rook__(char *, integer *, real *, 
	    integer *, integer *, real *, integer *, integer *, ftnlen), 
	    ssytrs_rook__(char *, integer *, integer *, real *, integer *, 
...
/*     Test the input parameters. */
	...
	*info = -10;
	...
	if (*n == 0) {
	    ...
	    ssytrf_rook__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &
		    c_n1, info, (ftnlen)1);
	    lwkopt = work[1];
	}
	work[1] = (real) lwkopt;
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    ssytrf_rook__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info,
	     (ftnlen)1);
    if (*info == 0) {
...
/*        Solve with TRS_ROOK ( Use Level 2 BLAS) */
	...
	ssytrs_rook__(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset]
		, ldb, info, (ftnlen)1);
