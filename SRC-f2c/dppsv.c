/* dppsv.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int dppsv_(char *uplo, integer *n, integer *nrhs, doublereal 
	*ap, doublereal *b, integer *ldb, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *, ftnlen), dpptrf_(
	    char *, integer *, doublereal *, integer *, ftnlen), dpptrs_(char 
...
/*     Compute the Cholesky factorization A = U**T*U or A = L*L**T. */
    ...
    dpptrf_(uplo, n, &ap[1], info, (ftnlen)1);
    if (*info == 0) {

/*        Solve the system A*X = B, overwriting B with X. */

	dpptrs_(uplo, n, nrhs, &ap[1], &b[b_offset], ldb, info, (ftnlen)1);
