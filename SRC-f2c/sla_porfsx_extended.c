/* sla_porfsx_extended.f -- translated by f2c (version 20100827).
...
/* > \brief \b SLA_PORFSX_EXTENDED improves the computed solution to a system of linear equations for symmetri
	...
	uplo_len)
{
    ...
    /* Local variables */
    static real dxratmax, dzratmax;
    static integer i__, j;
    static logical incr_prec__;
    extern /* Subroutine */ int sla_syamv__(integer *, integer *, real *, 
	    real *, integer *, real *, integer *, real *, real *, integer *);
    static real prev_dz_z__, yk, final_dx_x__, final_dz_z__;
    extern /* Subroutine */ int sla_wwaddw__(integer *, real *, real *, real *
	    );
    static real prevnormdx;
    static integer cnt;
    static real dyk, eps, incr_thresh__, dx_x__, dz_z__, ymin;
