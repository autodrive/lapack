...
/* > */
/*  ===================================================================== */
/* Subroutine */ int ssytrd_sy2sb__(char *uplo, integer *n, integer *kd, real 
	...
	integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *, 
	    ...
	    ftnlen, ftnlen), ssyr2k_(char *, char *, integer *, integer *, 
    ...
    extern /* Subroutine */ int sgelqf_(integer *, integer *, real *, integer 
	    *, real *, real *, integer *, integer *), sgeqrf_(integer *, 
	    ...
	    ), slarft_(char *, char *, integer *, integer *, real *, integer *
	    , real *, real *, integer *, ftnlen, ftnlen), slaset_(char *, 
