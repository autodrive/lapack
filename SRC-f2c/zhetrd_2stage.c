/* zhetrd_2stage.f -- translated by f2c (version 20100827).
...
/* > */
/*  ===================================================================== */
/* Subroutine */ int zhetrd_2stage__(char *vect, char *uplo, integer *n, 
	...
	ftnlen uplo_len)
{
    ...
    /* Local variables */
    static integer ib, kd, ldab;
    extern /* Subroutine */ int zhetrd_he2hb__(char *, integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, doublecomplex *, integer *, integer *, ftnlen), 
	    zhetrd_hb2st__(char *, char *, char *, integer *, integer *, 
...
/*     Determine the block size, the workspace size and the hous size. */
    ...
    kd = ilaenv_(&c__17, "ZHETRD_2STAGE", vect, n, &c_n1, &c_n1, &c_n1, (
	    ftnlen)13, (ftnlen)1);
    ib = ilaenv_(&c__18, "ZHETRD_2STAGE", vect, n, &kd, &c_n1, &c_n1, (ftnlen)
	    13, (ftnlen)1);
    lhmin = ilaenv_(&c__19, "ZHETRD_2STAGE", vect, n, &kd, &ib, &c_n1, (
	    ftnlen)13, (ftnlen)1);
    lwmin = ilaenv_(&c__20, "ZHETRD_2STAGE", vect, n, &kd, &ib, &c_n1, (
	    ftnlen)13, (ftnlen)1);
...
/*     Determine pointer position */
    ...
    abpos = 1;
    wpos = abpos + ldab * *n;
    zhetrd_he2hb__(uplo, n, &kd, &a[a_offset], lda, &work[abpos], &ldab, &tau[
    ...
    zhetrd_hb2st__("Y", vect, uplo, n, &kd, &work[abpos], &ldab, &d__[1], &e[
