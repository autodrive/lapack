	...
	integer *info, ftnlen jobz_len, ftnlen range_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *, 
	    ...
	    ), ssytrd_2stage__(char *, char *, integer *, real *, integer *, 
    ...
    extern /* Subroutine */ int sstebz_(char *, char *, integer *, real *, 
	    ...
	    integer *, ftnlen, ftnlen), sorgtr_(char *, integer *, real *, 
	    integer *, real *, real *, integer *, integer *, ftnlen);
    static logical lquery;
    extern /* Subroutine */ int ssteqr_(char *, integer *, real *, real *, 
	    real *, integer *, real *, integer *, ftnlen), sormtr_(char *, 
