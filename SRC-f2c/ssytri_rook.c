...
/*  ===================================================================== */
/* Subroutine */ int ssytri_rook__(char *uplo, integer *n, real *a, integer *
	lda, integer *ipiv, real *work, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *, 
	    ...
	    integer *, real *, real *, integer *, ftnlen), xerbla_(char *, 
	    integer *, ftnlen);
