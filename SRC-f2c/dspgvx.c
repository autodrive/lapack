/* dspgvx.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dspgvx.
f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dspgvx.
f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dspgvx.
f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
	...
	ftnlen range_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *, ftnlen), dpptrf_(
	    ...
	    *, ftnlen), dspevx_(char *, char *, char *, integer *, doublereal 
