...
/* Subroutine */ int ssyevr_2stage__(char *jobz, char *range, char *uplo, 
	...
	integer *liwork, integer *info, ftnlen jobz_len, ftnlen range_len, 
	ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int sstebz_(char *, char *, integer *, real *, 
	    ...
	    integer *, ftnlen, ftnlen), sstemr_(char *, char *, integer *, 
...
/*     Test the input parameters. */
    ...
    kd = ilaenv_(&c__17, "SSYTRD_2STAGE", jobz, n, &c_n1, &c_n1, &c_n1, (
	    ftnlen)13, (ftnlen)1);
    ib = ilaenv_(&c__18, "SSYTRD_2STAGE", jobz, n, &kd, &c_n1, &c_n1, (ftnlen)
	    13, (ftnlen)1);
