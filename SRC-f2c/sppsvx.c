...
/* Subroutine */ int sppsvx_(char *fact, char *uplo, integer *n, integer *
	...
	*work, integer *iwork, integer *info, ftnlen fact_len, ftnlen 
	uplo_len, ftnlen equed_len)
{
    ...
    extern /* Subroutine */ int sppcon_(char *, integer *, real *, real *, 
	    real *, real *, integer *, integer *, ftnlen), slaqsp_(char *, 
	    integer *, real *, real *, real *, real *, char *, ftnlen, ftnlen)
	    ;
    static real smlnum;
    extern /* Subroutine */ int sppequ_(char *, integer *, real *, real *, 
	    real *, real *, integer *, ftnlen), spprfs_(char *, integer *, 
	    integer *, real *, real *, real *, integer *, real *, integer *, 
	    real *, real *, real *, integer *, integer *, ftnlen), spptrf_(
	    char *, integer *, real *, integer *, ftnlen), spptrs_(char *, 
