/* dsygv_2stage.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/dsygv_2
stage.f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/dsygv_2
stage.f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/dsygv_2
stage.f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/*  ===================================================================== */
/* Subroutine */ int dsygv_2stage__(integer *itype, char *jobz, char *uplo, 
	...
	ftnlen jobz_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int dsyev_2stage__(char *, char *, integer *, 
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    dsygst_(itype, uplo, n, &a[a_offset], lda, &b[b_offset], ldb, info, (
	    ftnlen)1);
    dsyev_2stage__(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, 
...
/*           backtransform eigenvectors: x = inv(L)**T*y or inv(U)*y */
		...
		*(unsigned char *)trans = 'T';
	    ...
	    dtrsm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b26, &b[
...
/*           backtransform eigenvectors: x = L*y or U**T*y */
		...
		*(unsigned char *)trans = 'N';
	    ...
	    dtrmm_("Left", uplo, trans, "Non-unit", n, &neig, &c_b26, &b[
		    b_offset], ldb, &a[a_offset], lda, (ftnlen)4, (ftnlen)1, (
		    ftnlen)1, (ftnlen)8);
	}
    }
