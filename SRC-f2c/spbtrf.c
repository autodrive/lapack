	...
	integer *ldab, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int sgemm_(char *, char *, integer *, integer *, 
	    ...
	    integer *, ftnlen, ftnlen, ftnlen, ftnlen), ssyrk_(char *, char *,
	     integer *, integer *, real *, real *, integer *, real *, real *, 
	    integer *, ftnlen, ftnlen), spbtf2_(char *, integer *, integer *, 
	    real *, integer *, integer *, ftnlen), spotf2_(char *, integer *, 
	    real *, integer *, integer *, ftnlen), xerbla_(char *, integer *, 
	    ftnlen);
