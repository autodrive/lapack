/* zhesv_aa.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int zhesv_aa__(char *uplo, integer *n, integer *nrhs, 
	...
	ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int zhetrf_aa__(char *, integer *, doublecomplex *
	    , integer *, integer *, doublecomplex *, integer *, integer *, 
	    ftnlen), zhetrs_aa__(char *, integer *, integer *, doublecomplex *
...
/*     Test the input parameters. */
	...
	*info = -8;
    ...
    if (*info == 0) {
	zhetrf_aa__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], &c_n1, 
		info, (ftnlen)1);
	lwkopt_hetrf__ = (integer) work[1].r;
	zhetrs_aa__(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset], 
...
/*     Compute the factorization A = U*T*U**H or A = L*T*L**H. */
    ...
    zhetrf_aa__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info, (
	    ftnlen)1);
    if (*info == 0) {
