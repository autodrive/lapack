...
/* Subroutine */ int cgghd3_(char *compq, char *compz, integer *n, integer *
	...
	integer *lwork, integer *info, ftnlen compq_len, ftnlen compz_len)
{
    ...
    static complex temp1, temp2, temp3;
    ...
    extern /* Subroutine */ int cgghrd_(char *, char *, integer *, integer *, 
	    ...
	    complex *, integer *, ftnlen), clartg_(complex *, complex *, real 
