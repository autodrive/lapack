/* cla_porfsx_extended.f -- translated by f2c (version 20100827).
	...
	ftnlen uplo_len)
{
    ...
    static real prev_dz_z__, yk, final_dx_x__;
    extern /* Subroutine */ int cla_wwaddw__(integer *, complex *, complex *, 
	    complex *);
    static real final_dz_z__, prevnormdx;
    static integer cnt;
    static real dyk, eps, incr_thresh__, dx_x__, dz_z__;
...
/*     Compute abs(op(A_s))*abs(Y) + abs(B_s). */
	...
	cla_heamv__(&uplo2, n, &c_b34, &a[a_offset], lda, &y[j * y_dim1 + 1], 
