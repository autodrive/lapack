	...
	uplo_len)
{
    ...
    integer a_dim1, a_offset, h_dim1, h_offset, i__1, i__2, i__3;
    doublecomplex z__1;
...
/*           first column */
	    ...
	    i__1 = *m - j + 1;
	    i__2 = j - k1;
	    zgemv_("No transpose", &i__1, &i__2, &c_b6, &h__[j + k1 * h_dim1],
...
/*           Set A(J, J+1) = T(J, J+1) */
	    ...
	    i__2 = k + (j + 1) * a_dim1;
	    i__3 = k - 1 + j * a_dim1;
	    if (a[i__1].r == 0. && a[i__1].i == 0. && (a[i__2].r == 0. && a[
		    i__2].i == 0.) && (k == 1 || a[i__3].r == 0. && a[i__3].i 
		    == 0.)) {
		if (*info == 0) {
		    *info = j;
		}
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:M, J) = L(J+2:M, J+1) */
		...
		i__1 = *m - j - 1;
		zlaset_("Full", &c__1, &i__1, &c_b18, &c_b18, &a[k + (j + 2) *
			 a_dim1], lda, (ftnlen)4);
	    }
	} else {
	    i__1 = k + j * a_dim1;
	    i__2 = j - 1 + j * a_dim1;
	    if (a[i__1].r == 0. && a[i__1].i == 0. && (k == 1 || a[i__2].r == 
		    0. && a[i__2].i == 0.)) {
		if (*info == 0) {
		    *info = j;
		}
...
/*            where A(J, J+1) = T(J, J+1) and A(J+2:M, J) = L(J+2:M, J+1) */
		...
		i__1 = *m - j - 1;
		zlaset_("Full", &i__1, &c__1, &c_b18, &c_b18, &a[j + 2 + k * 
			a_dim1], lda, (ftnlen)4);
	    }
	} else {
	    i__1 = j + k * a_dim1;
