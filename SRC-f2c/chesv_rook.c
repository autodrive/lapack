/* chesv_rook.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int chesv_rook__(char *uplo, integer *n, integer *nrhs, 
	...
	complex *work, integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    static integer nb;
    extern /* Subroutine */ int chetrf_rook__(char *, integer *, complex *, 
	    integer *, integer *, complex *, integer *, integer *, ftnlen), 
	    chetrs_rook__(char *, integer *, integer *, complex *, integer *, 
...
/*     Compute the factorization A = U*D*U**H or A = L*D*L**H. */
    ...
    chetrf_rook__(uplo, n, &a[a_offset], lda, &ipiv[1], &work[1], lwork, info,
	     (ftnlen)1);
    if (*info == 0) {
...
/*        Solve with TRS ( Use Level BLAS 2) */
	...
	chetrs_rook__(uplo, n, nrhs, &a[a_offset], lda, &ipiv[1], &b[b_offset]
		, ldb, info, (ftnlen)1);
