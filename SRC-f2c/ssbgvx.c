...
/* Subroutine */ int ssbgvx_(char *jobz, char *range, char *uplo, integer *n, 
	...
	*work, integer *iwork, integer *ifail, integer *info, ftnlen jobz_len,
	 ftnlen range_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int spbstf_(char *, integer *, integer *, real *, 
	    integer *, integer *, ftnlen), ssbtrd_(char *, char *, integer *, 
	    integer *, real *, integer *, real *, real *, real *, integer *, 
	    real *, integer *, ftnlen, ftnlen), ssbgst_(char *, char *, 
    ...
    extern /* Subroutine */ int sstebz_(char *, char *, integer *, real *, 
	    ...
	    integer *, ftnlen, ftnlen), ssteqr_(char *, integer *, real *, 
