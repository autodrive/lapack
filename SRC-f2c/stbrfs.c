/* stbrfs.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int stbrfs_(char *uplo, char *trans, char *diag, integer *n, 
	...
	*ldb, real *x, integer *ldx, real *ferr, real *berr, real *work, 
	integer *iwork, integer *info, ftnlen uplo_len, ftnlen trans_len, 
	ftnlen diag_len)
{
    ...
    extern /* Subroutine */ int scopy_(integer *, real *, integer *, real *, 
	    ...
	    integer *, real *, integer *, ftnlen, ftnlen, ftnlen), saxpy_(
