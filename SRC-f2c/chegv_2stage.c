/* chegv_2stage.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int chegv_2stage__(integer *itype, char *jobz, char *uplo, 
	integer *n, complex *a, integer *lda, complex *b, integer *ldb, real *
	w, complex *work, integer *lwork, real *rwork, integer *info, ftnlen 
	jobz_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int cheev_2stage__(char *, char *, integer *, 
    ...
    extern /* Subroutine */ int chegst_(integer *, char *, integer *, complex 
	    *, integer *, complex *, integer *, integer *, ftnlen), cpotrf_(
...
/*     Transform problem to standard eigenvalue problem and solve. */
    ...
    chegst_(itype, uplo, n, &a[a_offset], lda, &b[b_offset], ldb, info, (
	    ftnlen)1);
    cheev_2stage__(jobz, uplo, n, &a[a_offset], lda, &w[1], &work[1], lwork, &
