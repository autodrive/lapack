/* dsytrd_sy2sb.f -- translated by f2c (version 20100827).
...
/* > */
/*  ===================================================================== */
/* Subroutine */ int dsytrd_sy2sb__(char *uplo, integer *n, integer *kd, 
	...
	ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int dsyr2k_(char *, char *, integer *, integer *, 
	    doublereal *, doublereal *, integer *, doublereal *, integer *, 
	    doublereal *, doublereal *, integer *, ftnlen, ftnlen), dgelqf_(
	    integer *, integer *, doublereal *, integer *, doublereal *, 
	    doublereal *, integer *, integer *), dgeqrf_(integer *, integer *,
	     doublereal *, integer *, doublereal *, doublereal *, integer *, 
	    integer *), dlarft_(char *, char *, integer *, integer *, 
	    doublereal *, integer *, doublereal *, doublereal *, integer *, 
	    ftnlen, ftnlen), xerbla_(char *, integer *, ftnlen), dlaset_(char 
...
/*     and test the input parameters */
    ...
    *info = 0;
    ...
    lquery = *lwork == -1;
    lwmin = ilaenv_(&c__20, "DSYTRD_SY2SB", "", n, kd, &c_n1, &c_n1, (ftnlen)
	    12, (ftnlen)0);
...
/*     way everytime T is generated the upper/lower portion will be always zero */
    ...
    dlaset_("A", &ldt, kd, &c_b17, &c_b17, &work[tpos], &ldt, (ftnlen)1);
