/* zspsvx.f -- translated by f2c (version 20100827).
	...
	uplo_len)
{
    ...
    extern /* Subroutine */ int zspcon_(char *, integer *, doublecomplex *, 
	    integer *, doublereal *, doublereal *, doublecomplex *, integer *,
	     ftnlen), zsprfs_(char *, integer *, integer *, doublecomplex *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, 
	    doublecomplex *, integer *, doublereal *, doublereal *, 
	    doublecomplex *, doublereal *, integer *, ftnlen), zsptrf_(char *,
...
/*        Compute the factorization A = U*D*U**T or A = L*D*L**T. */
	...
	zsptrf_(uplo, n, &afp[1], &ipiv[1], info, (ftnlen)1);
...
/*     Compute the norm of the matrix A. */
    ...
    anorm = zlansp_("I", uplo, n, &ap[1], &rwork[1], (ftnlen)1, (ftnlen)1);
