/* spftrs.f -- translated by f2c (version 20100827).
...
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.tgz?format=tgz&filename=/lapack/lapack_routine/spftrs.
f"> */
/* > [TGZ]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.zip?format=zip&filename=/lapack/lapack_routine/spftrs.
f"> */
/* > [ZIP]</a> */
/* > <a href="http://www.netlib.org/cgi-bin/netlibfiles.txt?format=txt&filename=/lapack/lapack_routine/spftrs.
f"> */
/* > [TXT]</a> */
/* > \endhtmlonly */
...
/* Subroutine */ int spftrs_(char *transr, char *uplo, integer *n, integer *
	nrhs, real *a, real *b, integer *ldb, integer *info, ftnlen 
	transr_len, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int stfsm_(char *, char *, char *, char *, char *,
	     integer *, integer *, real *, real *, real *, integer *, ftnlen, 
