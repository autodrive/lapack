/* chetri_3.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int chetri_3__(char *uplo, integer *n, complex *a, integer *
	...
	integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int chetri_3x__(char *, integer *, complex *, 
...
/*     Quick return if possible */
    ...
    chetri_3x__(uplo, n, &a[a_offset], lda, &e[1], &ipiv[1], &work[1], &nb, 
	    info, (ftnlen)1);
