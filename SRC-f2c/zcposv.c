/* zcposv.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int zcposv_(char *uplo, integer *n, integer *nrhs, 
	...
	doublereal *rwork, integer *iter, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int cpotrf_(char *, integer *, complex *, integer 
	    *, integer *, ftnlen), zlacpy_(char *, integer *, integer *, 
	    doublecomplex *, integer *, doublecomplex *, integer *, ftnlen), 
	    cpotrs_(char *, integer *, integer *, complex *, integer *, 
	    complex *, integer *, integer *, ftnlen), zpotrf_(char *, integer 
	    *, doublecomplex *, integer *, integer *, ftnlen), zpotrs_(char *,
...
/*     Compute some constants. */
    ...
    anrm = zlanhe_("I", uplo, n, &a[a_offset], lda, &rwork[1], (ftnlen)1, (
	    ftnlen)1);
...
/*     result in SA. */
    ...
    zlat2c_(uplo, n, &a[a_offset], lda, &swork[ptsa], n, info, (ftnlen)1);
...
/*     Compute the Cholesky factorization of SA. */
    ...
    cpotrf_(uplo, n, &swork[ptsa], n, info, (ftnlen)1);
...
/*     Solve the system SA*SX = SB. */
    ...
    cpotrs_(uplo, n, nrhs, &swork[ptsa], n, &swork[ptsx], n, info, (ftnlen)1);
...
/*     Compute R = B - AX (R is WORK). */
    ...
    zhemm_("Left", uplo, n, nrhs, &c_b1, &a[a_offset], lda, &x[x_offset], ldx,
	     &c_b2, &work[work_offset], n, (ftnlen)4, (ftnlen)1);
...
/*        Compute R = B - AX (R is WORK). */
	...
	zhemm_("L", uplo, n, nrhs, &c_b1, &a[a_offset], lda, &x[x_offset], 
		ldx, &c_b2, &work[work_offset], n, (ftnlen)1, (ftnlen)1);
