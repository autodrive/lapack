/* zsysvxx.f -- translated by f2c (version 20100827).
	...
	integer *info, ftnlen fact_len, ftnlen uplo_len, ftnlen equed_len)
{
    ...
    extern /* Subroutine */ int zlaqsy_(char *, integer *, doublecomplex *, 
	    ...
	    ftnlen, ftnlen), zsytrf_(char *, integer *, doublecomplex *, 
	    integer *, integer *, doublecomplex *, integer *, integer *, 
	    ftnlen), zlascl2_(integer *, integer *, doublereal *, 
	    doublecomplex *, integer *), zsytrs_(char *, integer *, integer *,
	     doublecomplex *, integer *, integer *, doublecomplex *, integer *
	    , integer *, ftnlen), zsyequb_(char *, integer *, doublecomplex *,
