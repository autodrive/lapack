/* dsytrf_rk.f -- translated by f2c (version 20100827).
...
/*  ===================================================================== */
/* Subroutine */ int dsytrf_rk__(char *uplo, integer *n, doublereal *a, 
	...
	*lwork, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int dsytf2_rk__(char *, integer *, doublereal *, 
	    integer *, doublereal *, integer *, integer *, ftnlen), 
	    dlasyf_rk__(char *, integer *, integer *, integer *, doublereal *,
...
/*           update columns 1:k-kb */
	    ...
	    dlasyf_rk__(uplo, &k, &nb, &kb, &a[a_offset], lda, &e[1], &ipiv[1]
		    , &work[1], &ldwork, &iinfo, (ftnlen)1);
	} else {

/*           Use unblocked code to factorize columns 1:k of A */

	    dsytf2_rk__(uplo, &k, &a[a_offset], lda, &e[1], &ipiv[1], &iinfo, 
		    (ftnlen)1);
	    kb = k;
	}
...
/*           update columns k+kb:n */
	    ...
	    i__1 = *n - k + 1;
	    dlasyf_rk__(uplo, &i__1, &nb, &kb, &a[k + k * a_dim1], lda, &e[k],
...
/*           Use unblocked code to factorize columns k:n of A */
	    ...
	    i__1 = *n - k + 1;
	    dsytf2_rk__(uplo, &i__1, &a[k + k * a_dim1], lda, &e[k], &ipiv[k],
		     &iinfo, (ftnlen)1);
	    kb = *n - k + 1;
