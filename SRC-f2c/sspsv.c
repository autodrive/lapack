/* sspsv.f -- translated by f2c (version 20100827).
...
/* Subroutine */ int sspsv_(char *uplo, integer *n, integer *nrhs, real *ap, 
	integer *ipiv, real *b, integer *ldb, integer *info, ftnlen uplo_len)
{
    ...
    extern /* Subroutine */ int xerbla_(char *, integer *, ftnlen), ssptrf_(
	    char *, integer *, real *, integer *, integer *, ftnlen), ssptrs_(
...
/*     Compute the factorization A = U*D*U**T or A = L*D*L**T. */
    ...
    ssptrf_(uplo, n, &ap[1], &ipiv[1], info, (ftnlen)1);
    if (*info == 0) {
