...
/*  ===================================================================== */
/* Subroutine */ int ssysv_rk__(char *uplo, integer *n, integer *nrhs, real *
	...
	work, integer *lwork, integer *info, ftnlen uplo_len)
{
    ...
    /* Local variables */
    extern /* Subroutine */ int ssytrs_3__(char *, integer *, integer *, real 
	    *, integer *, real *, integer *, real *, integer *, integer *, 
	    ftnlen), ssytrf_rk__(char *, integer *, real *, integer *, real *,
