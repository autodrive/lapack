...
/* Subroutine */ int sorcsd2by1_(char *jobu1, char *jobu2, char *jobv1t, 
	...
	integer *iwork, integer *info, ftnlen jobu1_len, ftnlen jobu2_len, 
	ftnlen jobv1t_len)
{
    ...
    static real dum1[1], dum2[1]	/* was [1][1] */;
    ...
    extern /* Subroutine */ int sbbcsd_(char *, char *, char *, char *, char *
	    ...
	    real *, integer *, integer *, ftnlen, ftnlen, ftnlen, ftnlen, 
	    ftnlen);
    ...
    extern /* Subroutine */ int sorbdb1_(integer *, integer *, integer *, 
	    ...
	    *, real *, real *, real *, real *, real *, integer *, integer *), 
	    sorbdb3_(integer *, integer *, integer *, real *, integer *, real 
	    *, integer *, real *, real *, real *, real *, real *, real *, 
	    integer *, integer *), sorbdb4_(integer *, integer *, integer *, 
	    real *, integer *, real *, integer *, real *, real *, real *, 
